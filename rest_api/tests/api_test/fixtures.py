...
class setup_txns:
    ...
    def setup_batch_valinv_txns(self):
    ...
    def setup_batch_invval_txns(self):
        """Setup method for posting batches and returning the 
           response
        """
        txns = [
    ...
    def setup_batch_invalid_txns(self):
        """Setup method for posting batches and returning the 
           response
        """  
    ...
    def setup_batch_valid_one_txns(self):
        """Setup method for posting batches and returning the 
           response
        """
        txns = [
    ...
    def setup_batch_valid_txns(self):
        """Setup method for posting batches and returning the 
           response
        """
        txns = [
...
def Txns():
        return setup_txns(invalidtype="None")
